...
//
    void on_actionRadioButtonBlink_triggered();
    void on_actionRadioButtonBreath_triggered();
    void on_actionRadioButtonSparkle_triggered();
    void on_actionRadioButtonTwinkle_triggered();
    void on_actionRadioButtonToneEnable_triggered();
    void on_actionRadioToneDecodeDisabled_triggered();
    void on_actionRadioSignalStrength_triggered();
//
    void on_actionRadioButtonPWMDisable_triggered();
    void on_actionRadioButtonPWMEnable_triggered();
